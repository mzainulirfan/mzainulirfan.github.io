...
var themeToggleBtn = document.getElementById("theme-toggle2");
...
window.onscroll = function () {
  ...
  const backToTopElement = document.getElementById("backToTopID");

  backToTopElement.classList.toggle("hidden", pageOffset < 150);
  backToTopElement.classList.toggle("visible", pageOffset >= 150);
};
